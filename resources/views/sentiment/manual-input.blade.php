...
<div class="flex bg-gray-100">
    ...
    <div class="flex flex-col flex-1">
        ...
        <main class="flex-1 p-4">
            {{-- <div class="w-full max-w-md flex flex-wrap">
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mr-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2" for="file1">
                        Input File
                    </label>
                    ...
                    <form method="POST" action="{{ route('data-latih.latih') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                            <input type="file" name="file" id="file1" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            @error('file')
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2 md:col-span-1 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <h2 class="text-xl font-bold text-gray-800 mb-4">Sentiment Analysis</h2>
                    <form method="POST" action="{{ route('menguji.data') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                            <input type="file" name="file" id="file2" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            @error('file')
